            ...
            <div class="ibox-content">
                <table id="tipo_amortizacion" class="table datatable">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php echo $row[nom_descripcion];?></td>
                            <td><button class="btn btn-defaul" onclick="controler('dmn=<?php echo $idMenu;?>&codigo=<?php echo $row[nom_codigo];?>&editar=1&ver=1', 'verContenido');">Editar</button></td>
                            <td><button class="btn btn-warning" onclick="controler('dmn=<?php echo $idMenu;?>&codigo=<?php echo $row[nom_codigo];?>&eliminar=1&ver=1', 'verContenido');">Eliminar</button></td>
                        </tr>
                        <?php
                            }
                        ?>
