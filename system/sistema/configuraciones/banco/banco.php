            ...
            <div class="ibox-content">
                <table id="tipo_amortizacion" class="table datatable">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php echo $row[ban_descripcion];?></td>
                            <td><button class="btn btn-defaul" onclick="controler('dmn=<?php echo $idMenu;?>&codigo=<?php echo $row[ban_codigo];?>&editar=1&ver=1', 'verContenido');">Editar</button></td>
                            <td><button class="btn btn-warning" onclick="controler('dmn=<?php echo $idMenu;?>&codigo=<?php echo $row[ban_codigo];?>&eliminar=1&ver=1', 'verContenido');">Eliminar</button></td>
                        </tr>
                        <?php
                            }
                        ?>
